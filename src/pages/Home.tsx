  ...
  return (
    <>
      <section className="hero" style={{
        background: "linear-gradient(rgba(21,21,21,0.4), rgba(75,61,52,0.5)), url(/hero.jpg) center/cover no-repeat",
        color: "var(--ea-paper)", textAlign: "center",
        aspectRatio: "2303 / 1536", display: "flex", flexDirection: "column",
